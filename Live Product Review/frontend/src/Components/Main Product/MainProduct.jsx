...
function MainProduct() {
  ...
  return (
    <div className='MainDivProductChartOverview'>
      <div className="mainProductDivMain-P flex">
        ...
        <div className="navbar-MainP flex">
          ...
          <svg 
            ...
            className='backButtonMain-P' width="29" height="30" viewBox="0 0 24 25"
            fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M15.125 6.62502C15.125 6.32168 14.9423 6.0482 14.662 5.93211C14.3818 5.81603 14.0592 5.88019 13.8447 6.09469L7.59467 12.3447C7.30178 12.6376 7.30178 13.1125 7.59467 13.4054L13.8447 19.6554C14.0592 19.8699 14.3818 19.934 14.662 19.8179C14.9423 19.7018 15.125 19.4284 15.125 19.125V6.62502Z" fill="#000000" />
          </svg>
        </div>
        ...
        <footer className="FooterMainP flex">
          ...
          <svg className="downArrowHomeFooter" width="24" height="25" viewBox="0 0 24 25"
            fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {
        !load && data && (
          <div ref={ChartRef} className="OverviewDivProductPage flex">
            {showChart && <ChartOverview data={data} />}
